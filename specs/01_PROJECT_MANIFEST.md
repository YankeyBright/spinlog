...
**One-liner:** A zero-runtime-dependency, ESM-only terminal feedback library capped at 10,240 gzip bytes.
...
4. **Exact Size Budget:** `dist/index.js` is at most 10,240 bytes after gzip level 9.
