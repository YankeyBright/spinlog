...
- The exact gzip gate rejects artifacts above 4,096 bytes. Size Limit independently measures gzip output while externalizing only the Node `util` and `process` built-ins used by the ESM artifact.
